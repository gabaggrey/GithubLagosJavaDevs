...
public class MainActivity extends AppCompatActivity {
    ...
    ProgressBar load;
    List<com.example.android.githublagosjavadevs.Users> users;
...
/*            https://api.github.com/search/users?q=location:lagos&page
            ...
            try {
                ...
                for (int i=0; i<items.length(); i++){
                    ...
                    com.example.android.githublagosjavadevs.Users githubUsers = new com.example.android.githublagosjavadevs.Users(serverProfilePicUrl, userName, uLink);
